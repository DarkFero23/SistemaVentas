    ...
    Private Sub btniniciar_Click(sender As Object, e As EventArgs) Handles btniniciar.Click
        Try
            ...
            If funciones.AccederUsuario(valores) Then
                MsgBox("Bienvenido", MsgBoxStyle.Information, "Mensaje de la aplicacion")
                FInicio.Show()
                Me.Hide()

            Else
                MsgBox("Usuario o Contraseña invalidos", MsgBoxStyle.Exclamation, "Mensaje de la aplicacion")
            End If
